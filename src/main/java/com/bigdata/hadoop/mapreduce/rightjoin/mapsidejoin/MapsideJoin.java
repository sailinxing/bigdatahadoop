package com.bigdata.hadoop.mapreduce.rightjoin.mapsidejoin;
...
public class MapsideJoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.setInputPaths(job, new Path("D:/testhadoopdata/input/mapsidejoin"));
        ...
        job.addCacheFile(new URI("file:/D:/testhadoopdata/input/mapjoincache/pdts.txt"));
